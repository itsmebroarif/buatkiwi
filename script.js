...
footer.href = " https://www.instagram.com/itsmebroarif.dev/ ";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hi Sayangku", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('Jahat banget emang ga kangen sama  aku ', '', 'error').then(function () {
                          Swal.fire('Yaudahlah Gapapa kok bener deh, GAPAPA !!')
                        })
                      }
                    })
                  })
